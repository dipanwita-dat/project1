...
function twentythirteen_setup() {
	...
	register_nav_menu( 'footer', __( 'Navigation footer Menu', 'twentythirteen' ) );
...
function my_custom_post_excecutive() {
  $labels = array(
    'name'               => _x( 'Excecutive', 'post type general name' ),
    'singular_name'      => _x( 'Excecutive', 'post type singular name' ),
    'add_new'            => _x( 'Add New', 'book' ),
    'add_new_item'       => __( 'Add New Excecutive' ),
    'edit_item'          => __( 'Edit Excecutive' ),
    'new_item'           => __( 'New Excecutive' ),
    'all_items'          => __( 'All Excecutive' ),
    'view_item'          => __( 'View Excecutive' ),
    'search_items'       => __( 'Search Excecutive' ),
    'not_found'          => __( 'No Banner found' ),
    'not_found_in_trash' => __( 'No Banner found in the Trash' ), 
    'parent_item_colon'  => '',
    'menu_name'          => 'Excecutive'
  );
  $args = array(
    'labels'        => $labels,
    'description'   => 'holds our excecutive',
    'public'        => true,
    'menu_position' => 5,
    'supports'      => array( 'title', 'editor', 'thumbnail'),
    'has_archive'   => true,
  );
  register_post_type( 'excecutive', $args ); 
}
add_action( 'init', 'my_custom_post_excecutive' );
...
add_action('executive', 'cust_field_text', 10, 2);
function cust_fields($defaults){
    $defaults['cust_col'] = __('cust fields');
    return $defaults;
}

add_filter('executive', 'cust_fields');